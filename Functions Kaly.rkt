...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |Kalysha Melendez Hernandez - Assignment 2|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Digital Ready CS002
...
;take in information and then gives you back data.
; Question 2:
; What does it mean for a function to have "side effects"?
;in some coding languages side effects can effect the state of your programming although
;it can be useful in some cases it can create later problems
; Question 3:
; What is one reason that functions are useful?
;functions alter the original state and makes it into a new state.
#|
Question 4:
