...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |Assignment 15|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
Digital Ready CS001
...
|#
;purpose: to see if the tree are positive 
...
|#
;purpose: find the how many files exist in the directory 
;signature: list-of-files -> number
...
|#
;purpose: find if a file is found in the target
;signature:
